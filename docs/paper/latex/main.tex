...
\emph{loses} two on the deep tier; LazyCode-batch pays 1--2\% of the
agent's bill on both.}
...
(HumanEval-50) & lazycode-sync & 46/50 & 0.0721 & 0.0016 & 2.2\,s/item \\
 & lazycode-batch & 47/50 & 0.0367 & 0.0008 & 8.1\,min/wave \\
\addlinespace
deep & agent (Claude Code) & 6/10 & 5.6923 & 0.9487 & 91\,s/item \\
(SWE-bench $\times$10) & lazycode-sync & 8/10 & 0.2582 & 0.0323 & 39\,s/item \\

...
The system is 18{,}415 lines of Python (8{,}845 in the package, 7{,}680 in tests, 1{,}890 in the benchmark harness) with 413 default tests (415 including 2 deselected e2e tests). Three findings from auditing our own code, reported because papers rarely do and reviewers always should.
